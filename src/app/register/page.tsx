...
const LeftPanel = () => {
    ...
    return (
        <div className="relative w-3/5 bg-gradient-to-b from-background via-background to-background">
            ...
            <div className="absolute top-0 -left-4 w-72 h-72 bg-cyan-300 dark:bg-cyan-900 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-xl opacity-20 animate-blob"></div>
            ...
            <div className="relative flex flex-col items-center justify-center min-h-screen p-20 z-10">
                <div className="w-full max-w-2xl space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        <div className="relative p-6 rounded-lg bg-card/70 backdrop-blur-sm border cyan-200 dark:cyan-800 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300">
