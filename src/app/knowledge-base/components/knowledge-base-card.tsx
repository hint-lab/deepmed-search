...
import { useDeleteKnowledgeBase } from "@/hooks/use-knowledge-base";
...
export function KnowledgeBaseCard({ item }: IKnowledgeBaseCardProps) {
    ...
    const { deleteKnowledgeBase, loading: deleteLoading } = useDeleteKnowledgeBase();
    useEffect(() => {
        console.log(item)
    }, [item,])
     ...
     * @param id - 知识库ID
     */
    const handleSetConfiguration = (id: string) => {
        router.push(`/knowledge-base/${id}?tab=settings`);
    };
    ...
    return (
        <Card className="w-[300px] h-[251px] flex flex-col justify-between">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={(e) => {
                                e.stopPropagation();
                                handleSetConfiguration(item.id);
                            }}>
                                {t('settings.title')}
                            </DropdownMenuItem>
                        </DropdownMenuContent>
            ...
            <CardContent className="p-6 pt-0 cursor-pointer" onClick={handleClick}>
