  ...
  return (
    ...
    >
      ...
      <Link
        href={
          isAgent
            ? 'https://deepdoc-x.io/docs/dev/http_api_reference#create-session-with-agent'
            : 'https://deepdoc-x.io/docs/dev/http_api_reference#create-session-with-chat-assistant'
        }
        target="_blank"
      >
