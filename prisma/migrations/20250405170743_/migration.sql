...
CREATE TABLE "LangfuseConfig" (
    ...
    CONSTRAINT "LangfuseConfig_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "KnowledgeFile" (
    ...
    "progress_msg" TEXT,
    "run" TEXT NOT NULL DEFAULT 'pending',
...
-- CreateIndex
CREATE UNIQUE INDEX "LangfuseConfig_userId_key" ON "LangfuseConfig"("userId");
...
-- AddForeignKey
ALTER TABLE "LangfuseConfig" ADD CONSTRAINT "LangfuseConfig_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "KnowledgeFile" ADD CONSTRAINT "KnowledgeFile_kb_id_fkey" FOREIGN KEY ("kb_id") REFERENCES "KnowledgeBase"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Chunk" ADD CONSTRAINT "Chunk_file_id_fkey" FOREIGN KEY ("file_id") REFERENCES "KnowledgeFile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
